...
sed -i '' "s/${SNAPSHOT_VERSION}/${NEW_VERSION}/g" redacted-compiler-plugin-gradle/gradle.properties
...
sed -i '' "s/${NEW_VERSION}/${SNAPSHOT_VERSION}/g" redacted-compiler-plugin-gradle/gradle.properties
